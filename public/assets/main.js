...
class Buttons {
    ...
    static UpdateHideButton() {
        ...
        if (document.getElementById("player").classList.contains("hidden")) {
            document.getElementById("hide_show_img").src = "./images/show.png";
            return;
        }
        document.getElementById("hide_show_img").src = "./images/hide.png";
    }
    static UpdateMuteButton() {
        ...
        if (!(Video.IsMuted() || Video.IsMuted() === undefined)) {
            document.getElementById("mute_sound_img").src = "./images/volume.png";
            return;
        }
        document.getElementById("mute_sound_img").src = "./images/mute.png";
    }
